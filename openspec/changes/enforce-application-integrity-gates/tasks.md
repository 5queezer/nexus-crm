...
- [x] 3.3 Update and validate the published OpenAPI request, response, policy, document, and conflict contracts.

## 4. Verification

- [x] 4.1 Run targeted RED/GREEN tests for each vertical behavior slice.
- [x] 4.2 Run Prisma validation/generation, full test suite, lint, build, OpenAPI lint, and strict OpenSpec validation.
