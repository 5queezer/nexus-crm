  ...
  return (
    <button
      ...
      className={variant === "menu"
        ? "language-menu-control flex min-h-10 w-full items-center justify-between rounded-lg px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-100 disabled:opacity-50 dark:text-slate-200 dark:hover:bg-white/[0.07]"
