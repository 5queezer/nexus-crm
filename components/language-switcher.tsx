  ...
  return (
    <button
      ...
      className={variant !== "compact"
        ? "language-menu-control nexus-focus-ring flex min-h-12 w-full items-center justify-between rounded-lg px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-100 disabled:opacity-50 dark:text-slate-200 dark:hover:bg-white/[0.07]"
    ...
    >
      ...
      <span className={variant !== "compact" ? "text-xs font-normal text-slate-500 dark:text-slate-400" : ""}>
        {locale === "de" ? "DE" : "EN"}
      </span>
    </button>
  );
