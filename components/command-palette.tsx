    ...
    >
      ...
      >
        ...
        <div className="flex items-center border-b border-gray-200 dark:border-gray-700 px-4">
          ...
          {statusLock && (
            <span
              className={`ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${STATUS_COLORS[statusLock]}`}
            >
              {ts(statusLock)}
              <button
        ...
        {onFocusView && (
          <div className="border-b border-gray-100 p-2 dark:border-gray-700">
            <button
              ...
              className="nexus-target flex w-full items-center justify-between rounded-lg px-3 text-left text-sm font-medium text-slate-700 hover:bg-slate-100 dark:text-slate-200 dark:hover:bg-white/6"
            >
              {t("focus_view")}
              <kbd className="rounded border border-slate-200 px-1.5 py-0.5 text-xs dark:border-white/10">
                F
              </kbd>
            </button>
          </div>
                ...
                {group.apps.map((app) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`shrink-0 inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium ${STATUS_COLORS[app.status]}`}
                      >
                        {ts(app.status)}
                      </span>
                    </button>
        ...
        <div className="border-t border-gray-100 dark:border-gray-700 px-4 py-2 flex items-center gap-4 text-[10px] text-gray-400 dark:text-gray-500">
          <span>
            <kbd className="px-1 py-0.5 border border-gray-200 dark:border-gray-600 rounded text-[10px]">
              ↑↓
            </kbd>{" "}
            {t("navigate")}
          </span>
