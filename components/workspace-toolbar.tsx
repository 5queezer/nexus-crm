		...
		<div className="mb-4 space-y-3 sm:mb-6">
			...
			<div className="grid w-full grid-cols-[auto_1fr] items-center gap-2 lg:flex lg:w-auto lg:flex-wrap">
				<div
					...
					className="col-span-2 grid min-h-12 w-full grid-flow-col overflow-hidden rounded-xl bg-slate-100 p-1 dark:bg-white/[0.055] lg:col-span-1 lg:inline-grid lg:w-auto"
				>
					{views.map((view) => (
						<button
							key={view.id}
